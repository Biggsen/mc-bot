...
const STRUCTURE_RECORDER_CONFIG = {
  ...
  swamp_huts: {
    heading: "Run Swamp Huts Y recorder",
    selectPlaceholder: "Select swamp huts input…",
    runLabel: "Run Swamp Huts recorder",
    progressLabel: "Swamp huts",
    run: (mcBot, opts) => mcBot.recorder.runSwampHuts(opts),
  },
  trail_ruins: {
  ...
  ocean_ruins: {
    heading: "Run Ocean Ruins Y recorder",
    selectPlaceholder: "Select ocean ruins input…",
    runLabel: "Run Ocean Ruins recorder",
    progressLabel: "Ocean ruins",
    run: (mcBot, opts) => mcBot.recorder.runOceanRuins(opts),
  },
  woodland_mansions: {
  ...
  buried_treasure: {
    ...
    selectPlaceholder: "Select buried treasure input…",
